...
export default function Home() {
  ...
  const topSubjects = [
    ...
    { name: "Chemistry", icon: "🧪", count: "100+ notes", color: "bg-red-500" },
    {
      name: "Engineering",
      icon: "⚙️",
      count: "180+ notes",
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              {user ? (
                <>
                  <Link
                    to="/upload"
                    className="bg-white text-blue-600 px-8 py-4 rounded-lg font-semibold text-lg hover:bg-blue-50 transition inline-flex items-center justify-center"
                  >
                  ...
                  <Link
                    to="/notes"
                    className="bg-blue-700 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-blue-800 transition inline-flex items-center justify-center"
                  >
                ...
                <>
                  ...
                  <Link
                    to="/notes"
                    className="bg-blue-700 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-blue-800 transition"
                  >
                    Browse Notes
                  </Link>
                </>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <form onSubmit={handleSearch} className="relative">
              <div className="flex items-center bg-white rounded-lg shadow-lg overflow-hidden">
                ...
                <button
                  type="submit"
                  className="bg-blue-600 text-white px-8 py-4 font-semibold hover:bg-blue-700 transition"
                >
                  Search
                </button>
              </div>
              ...
              {["Mathematics", "Physics", "Computer Science", "Chemistry"].map(
                (subject) => (
                  <button
                    ...
                    className="text-sm bg-white px-3 py-1 rounded-full border border-gray-300 hover:border-blue-500 hover:text-blue-600 transition"
                  >
                    {subject}
                  </button>
                )
